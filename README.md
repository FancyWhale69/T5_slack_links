...
- https://medium.com/nerd-for-tech/simple-linear-regression-with-deployment-using-flask-cafbf85fa96f
...
For those interested in applying nonlinear regression models as additional models to your projects (you are NOT required to use them, they will be explained in the context of classification):  
Neural Network:  
